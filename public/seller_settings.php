...
$query = "SELECT username, profile_pic, business_name, business_description, contact_number FROM users WHERE id = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['update_business_info'])) {
        ...
        $new_business_description = trim($_POST['business_description']);
        $new_contact_number = trim($_POST['contact_number']);
        
        $update_stmt = $conn->prepare("UPDATE users SET business_name = ?, business_description = ?, contact_number = ? WHERE id = ?");
        $update_stmt->bind_param("sssi", $new_business_name, $new_business_description, $new_contact_number, $user_id);
        if ($update_stmt->execute()) {
            $business_name = $new_business_name;
            $business_description = $new_business_description;
    ...
    <div class="dashboard-container">
        ...
        <main class="dashboard-content">
            <div class="settings-container">
                ...
                <div class="settings-section">
                    <h2 class="section-title"><i class="fas fa-store"></i> Business Information</h2>
                    
                    <form method="post">
                        <div class="form-group">
                            <label for="business_name">Business Name</label>
                            <input type="text" id="business_name" name="business_name" class="form-control" value="<?php echo htmlspecialchars($business_name); ?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="business_description">Business Description</label>
                            <textarea id="business_description" name="business_description" class="form-control"><?php echo htmlspecialchars($business_description); ?></textarea>
                        </div>
                        
                        <div class="form-group">
                            <label for="contact_number">Contact Number</label>
                            <input type="text" id="contact_number" name="contact_number" class="form-control" value="<?php echo htmlspecialchars($contact_number); ?>">
                        </div>
                        
                        <button type="submit" name="update_business_info" class="btn">Update Business Info</button>
                    </form>
                </div>
